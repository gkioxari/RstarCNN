...
def im_detect(net, im, gt_boxes):
    """Detect classes in an image given object proposals.
    """ 
    blobs, unused_im_scale_factors = _get_blobs(im, gt_boxes)
...
def test_net(net, imdb):
    ...
    imdb._write_results_file(all_boxes, 'attributes')
